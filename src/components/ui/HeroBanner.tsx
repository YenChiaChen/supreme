    ...
    >
      {center ? (
        <div className="container mx-auto h-full flex flex-col items-center justify-center text-center relative z-10">
          ...
          {description && (
            <p
              className="text-[16px] mt-6 tracking-wider leading-8 max-w-[50%] font-light whitespace-pre"
        ...
        <div className="container mx-auto h-full flex flex-col justify-end pb-[140px] px-8 text-[white] relative z-10">
          ...
          {description && (
            <p className="text-[18px] mt-4 font-light tracking-wider leading-8 max-w-[75%] whitespace-pre">
              {description}
            </p>
          )}
        </div>
