            ...
            <tbody className="">
              <tr>
                ...
                <td className="border-b border-light_gray px-4 py-2 content">
                  公司經營理念之一為創造最大利益，分享予股東及各利害關係人。若經營績效管理妥善，除了能增強股東、員工及價値鏈對我們的信心，也是邁向永續經營的關鍵。持續的營運績效成長可創造正向循環，提供公司繼續向上發展的動力。
                </td>
              ...
              <tr>
                ...
                <td className="border-b border-light_gray px-4 py-2 content">
                  人才培育和留任會影響公司的長期成長和可持續發展，故對公司至關重要。人才培育是讓員工能夠不斷成長和發展的過程，透過提供訓練和發展機會，公司可以幫助員工精進技能和知識，提高員工生產力和效率；同時公司對員工未來的投資和職涯發展的支持將强化員工對公司的忠誠度，進而促進員工的留任、減少人員流失，對公司的穩定性和經濟效益有正面積極的影響。
                </td>
                <td className="border-b border-light_gray px-12 py-2 text-center">
                  <Link
                    target="_blank"
              ...
              <tr>
                ...
                <td className="border-b border-light_gray px-4 py-2 content">
                  半導體零組件代理商之競爭優勢係即時提供客戶需求及掌握關鍵技術發展趨勢，優良的產品品質與技術，與提供客戶更多元的產品及完善的服務才能提昇客戶忠誠度，為公司帶來豐厚的利潤。
                </td>
                <td className="border-b border-light_gray px-12 py-2 text-center">
                  <Link
                    target="_blank"
              ...
              <tr>
                ...
                <td className="border-b border-light_gray px-4 py-2 content">
                  良好的勞雇/勞資關係有助於提高員工的士氣和工作效率，當員工感受到尊重和合理的待遇，將會更有動力和意願貢獻自己的力量。公正的薪資、優渥的福利和工作條件可以增加員工積極度和生產力，進而提高公司的營運效能和利潤。再者，維護良好的勞雇/勞資關係亦有助於提升公司的社會形象，使更多的客戶、投資者願意與公司成為商業夥伴，也吸引優良求職者前來應試，成為公司重要人才資產，有益於公司永續發展。
                </td>
                <td className="border-b border-light_gray px-12 py-2 text-center">
                  <Link
                    target="_blank"
              ...
              <tr>
                ...
                <td className="border-b border-light_gray px-4 py-2 content">
                  ...
                  <br />
                  我們相信公司治理與環境、社會、人權呈正向關係，愈加優化的公司治理將能為市場提供更高品質的產品及服務，亦可提升股東權益，為公司帶來正面效益。
                </td>
                <td className="border-b border-light_gray px-12 py-2 text-center">
                  <Link
                    target="_blank"
              ...
              <tr>
                ...
                <td className="border-b border-light_gray px-4 py-2 content">
                  氣候變遷的主要影響是極端氣候的發生，例如暴風、熱浪、乾旱及洪災等，也帶來企業營運的風險，本公司為通路商且以進出口為主，仰賴國際運輸交通甚深，交通受天氣變化影響甚遠，如供應鏈上下游，若任一環節因極端氣候造成交通中斷，亦將造成公司營運上的負面影響。
                </td>
                <td className="border-b border-light_gray px-12 py-2 text-center">
                  <Link
                    target="_blank"
