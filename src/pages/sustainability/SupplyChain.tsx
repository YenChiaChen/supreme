      ...
      <div className="bg-white">
        <div className="container mx-auto px-[10%] mt-8 pt-18">
          ...
          <div className="flex flex-col gap-4">
            <div
              tabIndex={0}
              className="collapse collapse-arrow shadow  p-4 relative group"
            >
              <div className="absolute w-full h-[95px] duration-300 group-hover:bg-orange  left-0 top-0"></div>
              <div className="collapse-title flex">
                <span className="text-lg group-hover:text-white">供應商 / 承攬商管理政策</span>
              </div>
            ...
            >
              <div className="absolute w-full h-[95px] duration-300 group-hover:bg-orange  left-0 top-0"></div>
              <div className="collapse-title flex">
                <span className="text-lg group-hover:text-white">供應商 / 承攬商管理機制</span>
              </div>
              <div className="collapse-content content">
                <p>
            ...
            >
              <div className="absolute w-full h-[95px] duration-300 group-hover:bg-orange  left-0 top-0"></div>
              <div className="collapse-title flex">
                <span className="text-lg group-hover:text-white">供應商新增及異動</span>
              </div>
              <div className="collapse-content content">
            ...
            >
              <div className="absolute w-full h-[95px] duration-300 group-hover:bg-orange  left-0 top-0"></div>
              <div className="collapse-title flex">
                <span className="text-lg group-hover:text-white">重要採購</span>
              </div>
              <div className="collapse-content content">
