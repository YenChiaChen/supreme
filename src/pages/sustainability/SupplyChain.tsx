        ...
        <div className="container mx-auto px-[10%] mt-8 pt-18">
          ...
          <div tabIndex={0} className="collapse collapse-arrow shadow  p-4">
            <div className="collapse-title flex">
              <span className="text-lg">供應商 / 承攬商管理政策</span>
            </div>
          ...
          <div tabIndex={0} className="collapse collapse-arrow shadow  p-4">
            <div className="collapse-title flex">
              <span className="text-lg">供應商 / 承攬商管理機制</span>
            </div>
            <div className="collapse-content content">
              <p>
          ...
          <div tabIndex={0} className="collapse collapse-arrow shadow  p-4">
            <div className="collapse-title flex">
              <span className="text-lg">供應商遴選</span>
            </div>
            <div className="collapse-content content">
          ...
          <div tabIndex={0} className="collapse collapse-arrow shadow  p-4">
            <div className="collapse-title flex">
              <span className="text-lg">供應商新增及異動</span>
            </div>
            <div className="collapse-content content">
          ...
          <div tabIndex={0} className="collapse collapse-arrow shadow  p-4">
            <div className="collapse-title flex">
              <span className="text-lg">重要採購</span>
            </div>
            <div className="collapse-content content">
