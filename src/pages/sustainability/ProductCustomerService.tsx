...
const ProductCustomerService: React.FC = () => {
  ...
  const items = [
    {
      title: <p>未來研發計畫及投入之研發費用</p>,
      children:
        <><p>2022年度依消費性電子產品市場需求訂定不同之研發專案，研發費用計投入新台幣88,789仟元，預計2023 年度將再投入約80,000仟元持續開發快篩試劑、試劑檢測儀、醫療雲端服務、電動車電池組、EXN交換站及影像產品研發與製造等產品。近三年個體財務報告所載之累計投入研發費用：</p>
        <img src={img02} className="max-w-[800px] w-full mt-sm" alt='img' /></>,
    },
    {
      title: <p>重大創新技術開發</p>,
      children:
        <p>目前持續研發之新產品為全民健康快速篩檢系統、試劑檢測儀、醫療雲端服務、次世代生物科技、電動車電池組、雲端能源交換管理系統(EnergyeXchangeNetwork)、安全性鋰電池材料、低電壓電力推進系統整合方案及大型儲能設備與能源管理系統(EMS)等產品。 對公司績效的貢獻度，而給予合理報酬，相關績效考核及薪酬合理性均經薪資報酬委員會及董事會審核，並隨 時視實際經營狀況及法令適時檢討酬金制度，以謀公司永續經營與風險控管之平衡。依本公司章程第二十條， 本公司年度扣除員工酬勞及董事酬勞前之本期稅前淨利，應提撥不高於百分之二為董事酬勞，由董事會決議後 分派，並向股東會報告。</p>,
    },
    {
      title: <p>完成 ISO-13485 的認證</p>,
      children:
        <p>研發部門成立迄今，除以提供客戶技術支援外，亦積極尋求新產品的合作開發案，以多元化的產品應用觀念與其核心關鍵技術，同時導入系統整合設計，協助客戶用最短的時間及最有效率的方式，完成產品開發與量產，帶來新商機；另外在遠距智慧醫療產品線的布建需求下，完成ISO-13485的認證，以利後續相關服務及產品的銷售推動，目前已取得科專計畫及專利項目。(EnergyeXchangeNetwork)、安全性鋰電池材料、低電壓電力推進系統整合方案及大型儲能設備與能源管理系統(EMS)等產品。 對公司績效的貢獻度，而給予合理報酬，相關績效考核及薪酬合理性均經薪資報酬委員會及董事會審核，並隨 時視實際經營狀況及法令適時檢討酬金制度，以謀公司永續經營與風險控管之平衡。依本公司章程第二十條， 本公司年度扣除員工酬勞及董事酬勞前之本期稅前淨利，應提撥不高於百分之二為董事酬勞，由董事會決議後 分派，並向股東會報告。</p>,
    },
  ];
