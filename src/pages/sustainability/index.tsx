...
import BgImage from "../../assets/img/bg/bg03.png";
import BgImage01 from "../../assets/img/bg/subPage/永續經營/經營者的話.jpg";
import BgImage02 from "../../assets/img/bg/subPage/永續經營/公司治理.jpg";
import BgImage03 from "../../assets/img/bg/subPage/永續經營/誠信經營.jpg";
import BgImage04 from "../../assets/img/bg/subPage/永續經營/董事會.jpg";
import BgImage05 from "../../assets/img/bg/subPage/永續經營/永續發展委員會.jpg";
import BgImage06 from "../../assets/img/bg/subPage/永續經營/薪酬委員會.jpg";
import BgImage07 from "../../assets/img/bg/subPage/永續經營/審計委員會.jpg";
import BgImage08 from "../../assets/img/bg/subPage/永續經營/利害關係人議合.jpg";
import BgImage09 from "../../assets/img/bg/subPage/永續經營/重大主題.jpg";
import BgImage10 from "../../assets/img/bg/subPage/永續經營/利害關係人問卷.jpg";
import BgImage11 from "../../assets/img/bg/subPage/永續經營/風險管理.jpg";
import BgImage12 from "../../assets/img/bg/subPage/永續經營/資訊安全管理.jpg";
import BgImage13 from "../../assets/img/bg/subPage/永續經營/供應鏈管理.jpg";
import BgImage14 from "../../assets/img/bg/subPage/永續經營/產品與客戶服務.jpg";
import BgImage15 from "../../assets/img/bg/subPage/永續經營/智慧財產權管理.jpg";
            ...
            <div className="grid grid-cols-2 mt-36 gap-4 relative  text-[#333333]">
              <div className="grid grid-cols-8 gap-8 group relative">
                ...
                <div className="col-span-5 content py-8 ">
                  ...
                  <Desc
                    text={
                      "遵循政府法令，並持誠信原則，強化董監職能，深耕企業文化，健全公司發展，實踐永續經營。"
                    }
                  />
                </div>
              ...
              <div className="text-blue rounded-full bg-white sub-title absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[140px] h-[140px] flex items-center justify-center">
                永續
                <br />
                經營
              </div>
