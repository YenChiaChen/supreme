...
const GreenEnergy: React.FC = () => {
  ...
  return (
    <div className="mb-48">
      <HeroSection
        title="綠能低碳計畫"
        description={`半導體零組件代理商之競爭優勢係即時提供客戶需求及掌握關鍵技術發展趨勢，優良的產品品質與技術，與提供客戶更多元的產品及完善的服務才能提昇客戶忠誠度，為公司帶來豐厚的利潤。`}
      ...
      <Container className="mt-12">
        ...
        <Section>
          <H2 text={"已取得之專利項目"} />
          <OldTable columns={columnsList} data={patentList} color="#3BC376"/>
        </Section>
